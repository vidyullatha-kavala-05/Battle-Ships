...
public class BattlesShipProject {
    public static int numRows = 10;
    public static int numCols = 10;
    public static int playerShips;
    public static int computerShips;
    public static String[][] arr = new String[numRows][numCols];
    ...
    public static void deployPlayerShips(){
        ...
        for (int i = 1; i <= BattleShips.playerShips; ) {
            ...
            if((x >= 0 && x < numRows) && (y >= 0 && y < numCols) && (arr[x][y] == " "))
            {
                arr[x][y] =   "@";
                i++;
            }
            else if((x >= 0 && x < numRows) && (y >= 0 && y < numCols) && arr[x][y] == "@")
                System.out.println("Can't place two or more ships in the same location");
            else if ((x < 0 || x >= numRows) || (y < 0 || y >= numCols))
                System.out.println("Can't place ships outside the " + numRows + " by " + numCols + " array");
        }
        printOceanMap();
    }
    ...
    public static void playerTurn(){
        ...
        do {
            ...
            {
                if (arr[x][y] == "x") //if computer ship is already there; computer loses ship
                {
    ...
    public static void computerTurn(){
        ...
        do {
            ...
            if ((x >= 0 && x < numRows) && (y >= 0 && y < numCols)) //valid guess
            {
                if (arr[x][y] == "@") //if player ship is already there; player loses ship
                {
